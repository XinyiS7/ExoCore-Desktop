              ...
              >
                {filteredParticipants.map((p, i) => (
                  ...
                  >
                    ...
                    {p.isUser && (
                      <span className="text-[8px] font-mono text-exo-muted/40 uppercase tracking-wider ml-auto flex-shrink-0">You</span>
                    )}
                  </button>
                ))}
                {filteredParticipants.length === 0 && (
                  <div className="px-3 py-4 text-center text-[10px] text-exo-muted/40 font-mono uppercase tracking-wider">
                    No matches
                  </div>
                )}
              </div>
