...
import { groupchatApi, getCsrfToken, baseUrl } from 'exo-shared';
...
export default function GroupchatRoom({ groupchat, presets, onBack, onManage }) {
  ...
  }, [presets, userNick, userAvatarUrl]);
  ...
  return (
    <div className="flex-1 min-w-0 flex flex-col min-h-0 bg-exo-bg relative">
      ...
      <div className="relative z-20 flex-shrink-0 border-b border-exo-mist-10 bg-exo-pure/40 backdrop-blur-md px-4 md:px-6 py-2 flex items-center justify-between">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <span className="text-[9px] font-mono text-exo-muted/40">
      ...
      >
        ...
        {isLoadingMore && (
          <div className="flex justify-center py-3">
            <span className="text-[10px] uppercase tracking-[0.2em] text-exo-muted flex items-center gap-2 animate-pulse">
        ...
        {messages.length === 0 && !isLoadingMore && (
          <div className="flex items-center justify-center h-full py-20">
            <div className="text-center space-y-3">
              ...
              <p className="text-[10px] font-mono text-exo-muted/20 uppercase tracking-widest">Start the conversation</p>
            </div>
          </div>
        )}
      ...
      <div className="flex-shrink-0 p-4 border-t border-exo-mist-10 bg-exo-pure/80 backdrop-blur-xl relative z-10">
        {sendError && (
          <div className="mb-2 text-[11px] font-mono text-red-400 bg-red-500/5 border border-red-500/20 rounded-[2px] px-3 py-2 flex items-center justify-between">
            <span>{sendError}</span>
        ...
        <div className="flex items-end gap-3">
          <textarea
            ...
            rows={1}
            disabled={isSending}
            className="flex-1 bg-exo-pure border border-exo-mist-10 rounded-[4px] px-4 py-2.5 text-sm text-white/90 outline-none resize-none focus:border-exo-accent/40 transition-colors font-sans placeholder:text-exo-muted/40 disabled:opacity-50 max-h-[40vh]"
