    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-exo-panel border border-exo-border rounded-xl w-full max-w-lg mx-4 p-6 shadow-2xl">
        ...
        <div className="space-y-4 mb-4">
          <div>
            <label className="text-[10px] font-mono uppercase tracking-wider text-exo-muted block mb-1.5">Project Name</label>
            <input
              ref={inputRef}
              type="text"
              value={name}
          ...
          <div>
            <label className="text-[10px] font-mono uppercase tracking-wider text-exo-muted block mb-1.5">Description (optional)</label>
            <input
              type="text"
              value={description}
