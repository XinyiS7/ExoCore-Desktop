      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        {showFilesButton && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] text-cinder-text-faint hover:text-cinder-flame border border-white/[0.06] hover:border-cinder-flame/30 rounded transition-all"
            title="Project Files"
          >
