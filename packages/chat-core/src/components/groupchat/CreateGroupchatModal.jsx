      ...
      <div className="bg-exo-pure border border-exo-mist-12 rounded-[4px] shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-mono uppercase tracking-[0.2em] text-exo-muted">Name</label>
            <input
              type="text"
              value={name}
          ...
          {/* Prompt */}
          <div className="space-y-1.5">
            <label className="text-[10px] font-mono uppercase tracking-[0.2em] text-exo-muted">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-t border-exo-mist-10 bg-white/[0.02]">
          <div>
            {isEdit && (
              <button
                ...
                disabled={deleting}
                className="px-3 py-1.5 text-red-400/60 hover:text-red-400 hover:bg-red-500/10 border border-transparent hover:border-red-500/20 rounded-[2px] text-[10px] font-mono uppercase tracking-widest transition-all flex items-center gap-1.5 disabled:opacity-30"
              >
                <Trash2 size={12} />
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onClose}
              className="px-4 py-1.5 text-[10px] font-mono uppercase tracking-widest text-exo-muted hover:text-white transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="px-4 py-1.5 bg-exo-accent/10 text-exo-accent border border-exo-accent/20 rounded-[2px] text-[10px] font-mono uppercase tracking-widest hover:bg-exo-accent hover:text-black transition-all flex items-center gap-1.5 disabled:opacity-30"
            >
              <Plus size={12} />
