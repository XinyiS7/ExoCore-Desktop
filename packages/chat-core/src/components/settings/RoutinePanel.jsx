        ...
        <div className="mb-5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 flex-shrink-0 ml-3">
              <button className="flex items-center gap-1 text-[9px] font-mono uppercase tracking-wider text-chat-muted/40 hover:text-chat-muted/70 border border-white/[0.06] rounded px-2 py-1 transition-colors">
                <Clock size={10} /> 时间设置
              </button>
              <button
